...
def green_mountain():
    ...
    for i in range(40):
        for j in range(40):
            ...
            beginShape()
            texture(mountainTexture)
            vertex(-100 + i * 5, -100 + j * 5, 0, i / 40.0, j / 40.0)
            vertex(-100 + (i+1) * 5, -100 + j * 5, 0, (i+1) / 40.0, j / 40.0)
            vertex(-100 + (i+1) * 5, -100 + (j+1) * 5, 0, (i+1) / 40.0, (j+1) / 40.0)
            vertex(-100 + i * 5, -100 + (j+1) * 5, 0, i / 40.0, (j+1) / 40.0)
            endShape()
    popMatrix()
